        ...
        databaseReference.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (questionNumber < questions.size) {
                    ...
                    dialogMessage.setPositiveButton("See Result", DialogInterface.OnClickListener { dialogInterface, i ->
                        sendScore()
                    })
                    dialogMessage.setNegativeButton("Play Again", DialogInterface.OnClickListener { dialogInterface, i ->
